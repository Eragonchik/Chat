...
export const Chat: FC<{sendMessage : (color : string, text : string) => void}> = (props) => {
  ...
  useEffect(() => {
    ...
    function memberRemovedHandler(member : IMember){
      ...
      setMembersInfo((prev)=> [...prev.filter((item) => item.id != member.id)])
                      ...
                      <li key={memberInfo.id}>
                        <div className="d-flex bd-highlight">
                          <div className="img_cont">
                            ...
                            />
                            <span className="online_icon" style={{backgroundColor: memberInfo.info.color}}></span>
                          </div>
                ...
                <div className="card-body msg_card_body">
                  {
                    messages.map((message) => {
                      ...
                      return (
                      <div key={message.id} className={"d-flex mb-4 " + (isMe ? 'justify-content-end' : 'justify-content-start')}>
                        {!isMe && (<div className="img_cont_msg">
                          <Image
                            src={message.img}
                            width={38}
                            height={38}
                        ...
                        <div className="msg_cotainer" style={{backgroundColor: message.color}}>
                          {message.text}
                  ...
                  <div className="input-group">
                    <div className="input-group-append">
                      <span className="input-group-text attach_btn">
                        <button className="btn" onClick={clearMessage}>Clear</button>
                      </span>
                    </div>
                    <textarea
                      name=""
                    ...
                    <div className="input-group-append">
                      <span className="input-group-text send_btn">
                        <button className="btn" onClick={sendMessageFunc}>Send</button>
                      </span>
                    </div>
                  </div>
                </div>
